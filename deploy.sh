...
kubectl set image deployments/client-deployment server=163494315/multi-client:$SHA
kubectl set image deployments/worker-deployment server=163494315/multi-worker:$SHA
